...
var OrdersFilterPipe = (function () {
    ...
    OrdersFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (orders) { return orders.itemName.toLocaleLowerCase().indexOf(filterBy) !== -1; }) : value;
    };
